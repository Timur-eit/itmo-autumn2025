...
export const PassengersPage = () => {
  ...
  return (
    <div className={styles.root}>
      ...
      <Text size="xs" weight="light" view="secondary" align="left">
        Учебное приложение (демонстрационный проект). Данное приложение
        разработано исключительно в рамках учебного процесса и предназначено для
        демонстрации технических решений. Все данные являются сгенерированными и
        получены из открытой учебной базы данных PostgreSQL Demo Database. Любые
        совпадения с реальными лицами, именами или контактной информацией
        являются случайными. Персональные данные реальных людей в приложении не
        используются и не обрабатываются.
      </Text>
